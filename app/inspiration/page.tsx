...
export default function InspirationPage() {
  ...
  const { user } = useAuth();
  const { setUserQuery, loadSuggestedActivities, suggestedActivitiesLoading } =
    useAppContext();

  const userWantsQuestion = "What do u fancy and when can you make it?";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      try {
        console.log(
          "No webhook configured, trying Firebase suggested activities..."
        );
          ...
          <div className="max-w-4xl mx-auto">
            <form onSubmit={handleSubmit} className="relative">
              ...
              <p className="text-center text-gray-500 dark:text-gray-400 mt-6 text-sm font-light">
                Be specific about your location, time available, and interests
